...
REVOKE EXECUTE ON FUNCTION public.increment_stat(text, uuid) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.increment_stat(text, uuid) FROM anon;
GRANT EXECUTE ON FUNCTION public.increment_stat(text, uuid) TO authenticated;